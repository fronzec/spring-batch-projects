...
public class JobsManagerService {
  ...
  public void init() {
    ...
    // TODO: 19/02/2022 refactor default params to add boolean that allow indicate if param is used
  ...
  public Map<String, String> syncRunJobWithParams(SingleJobDataRequest request) {
    ...
    if (jobs.containsKey(request.getJobBeanName())) {
      try {
        ...
        launchedJobMetadata.put(
            "parameters", JsonUtils.parseObject2Json(jobParametersBuilder.toJobParameters()));
